...
| sprechen / reden **über** (+Akk) / **von** (+Dat) | to talk about |

⚠️ Same verb, different preposition, different meaning: *sich freuen **auf*** (look forward to — future)
vs *sich freuen **über*** (be glad about — now/past). The preposition carries the meaning.
...
But if it's a **person**, keep preposition + pronoun:

> Ich warte **auf meinen Bruder**. → **Auf wen** wartest du? — Ich warte **auf ihn**.
