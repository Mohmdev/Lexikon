...
|---|---|---|
| base | — | schnell (fast) |
| **comparative** | + **-er** | schnell**er** (faster) |
| **superlative** | **am** + **-sten** | **am** schnell**sten** (fastest) |
...
When you mean "faster" **in front of a noun**, the comparative takes the ending **on top**, giving a
double -er:

> ein **schneller** Wagen — a fast car
> ein **schnellerer** Wagen — a faster car

And **predicatively** there's never any confusion, because predicative adjectives never take an
ending — so any -er after *ist* is the comparative: *Das Auto ist schneller* = the car is faster.
