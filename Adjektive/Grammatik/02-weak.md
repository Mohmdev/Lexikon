...
Prerequisite: the **cases** ([../../Grammatik/01-cases.md](../../Grammatik/01-cases.md)) and the
**article table** ([../../Artikel/Bestimmte.md](../../Artikel/Bestimmte.md)). The *why* behind
the relaxing is [01-why-endings.md](./01-why-endings.md).

---

## The table (adjective *schnell*)

| | masculine | feminine | neuter | plural |
|---|---|---|---|---|
| **Nominativ** | der schnell**e** | die schnell**e** | das schnell**e** | die schnell**en** |
| **Akkusativ** | den schnell**en** | die schnell**e** | das schnell**e** | die schnell**en** |
| **Dativ** | dem schnell**en** | der schnell**en** | dem schnell**en** | den schnell**en** |
| **Genitiv** | des schnell**en** | der schnell**en** | des schnell**en** | der schnell**en** |

## The rule in one line

**-e** in the top-left block — the **three singular Nominativ** cells, plus **feminine & neuter
