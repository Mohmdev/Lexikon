# Mixed endings — after ein / kein / mein

Good news: this is **the weak table with exactly three cells changed**. Learn weak
([02-weak.md](./02-weak.md)) and you're 90% done here.
...
(The *why* in full: [01-why-endings.md](./01-why-endings.md).)

---

## The table (adjective *schnell*)

| | masculine | feminine | neuter | plural *(kein)* |
|---|---|---|---|---|
| **Nominativ** | ein schnell**er** | eine schnell**e** | ein schnell**es** | keine schnell**en** |
| **Akkusativ** | einen schnell**en** | eine schnell**e** | ein schnell**es** | keine schnell**en** |
...
jobs — see [05-comparison.md](./05-comparison.md).

Next: **no article at all** — the adjective carries *everything*. [04-strong.md](./04-strong.md).
