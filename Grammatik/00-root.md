...
but run *underneath* all of them. Cases decide your articles and adjective endings; prepositions pull
cases; word order wraps the whole sentence. Get these and the per-word sections (nouns, adjectives,
verbs) stop feeling like separate puzzles — they're all running on the same engine.

Here's the foundation, in the order it's worth learning.

---

## 1. Cases — what job a word is doing
