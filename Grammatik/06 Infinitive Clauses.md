...
| --------- | ------- | ------- |
| **um … zu** | in order to (purpose) | Ich lerne Deutsch, **um** in Berlin **zu** arbeiten. — …in order to work in Berlin. |
| **ohne … zu** | without (doing) | Er ging, **ohne** **zu** zahlen. — He left without paying. |
| **(an)statt … zu** | instead of (doing) | **Statt** **zu** arbeiten, schläft er. — Instead of working, he sleeps. |
...
> ✅ **Ich** lerne Deutsch, um **(ich)** in Berlin zu arbeiten. — same subject (I learn / I work)

If the two subjects differ, you **can't** use *um…zu* — switch to a **damit** clause (a normal
subordinate clause with its own subject and verb-to-the-end, [[Konjunktionen]]):

> ✅ Ich erkläre es, **damit du** es **verstehst**. — I explain it so that *you* understand.
> ❌ ~~Ich erkläre es, um du zu verstehen~~ — different subjects, so *um…zu* is wrong.

Quick check: **same subject → um…zu; different subject → damit.**
