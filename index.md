...
1. **Compute vs. memorize.** For anything new, ask: can I *derive* this from a rule, or must I *store*
   ...
   shape computes; a noun's gender memorizes.)
2. **Closed set vs. open set.** A **closed** set (the 6 modals, the two-way prepositions, the question
   words) you grind to mastery *once* and own forever. An **open** set (nouns, adjectives) is infinite —
   you don't memorize it, you learn a **generator** (the *Wortbildung* rules) to handle new members.
3. **Store the fingerprint, not the machinery.** Don't memorize full conjugation tables — memorize the
   few **principal parts** that regenerate them. Nouns: the **triple** (article + singular + plural).
...
- [[Artikel]] — *der / die / das*, the grid that pronouns and adjective endings all copy.
- [[Präpositionen]] — each one forces a case (*mit + Dativ*, *für + Akkusativ*), sliced again by meaning.
- [[Pronomen]] — *ich / mich / mir …*, learned by case.

## The words — running on the engine

**Naming & describing**

- [[Nomen]] — nouns. Always learn the **triple**: article + singular + plural (*das Haus, die Häuser*),
  plus the suffix→gender generator.
- [[Adjektive]] — describing words; endings that **signal gender/case once**, plus comparison & word-building.
- [[Adverbien]] — how / when / where / why; the **position game** (adverbs never change form).

**Connecting & flavoring**

- [[Konjunktionen]] — joining words, sorted by **what they do to the verb** (stays / to-the-end / inverts).
- [[Partikeln]] — tone & focus words (*doch, mal, ja* / *auch, nur, sogar*) with no clean English equal.
- [[Interjektionen]] — *ja / nein / doch* and the raw exclamations.

**Counting, asking, doing**
